...
class DeleteProjectView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        """
        Override post instead of delete to properly handle the protected relationships
        """
        ...
        try:
            with transaction.atomic():
                self._delete_project_images(
                    self.object, success_messages, error_messages)
                self._delete_project_videos(
                    self.object, success_messages, error_messages)
    ...
    def _delete_project_images(self, project, success_messages, error_messages):
    ...
    def _delete_project_videos(self, project, success_messages, error_messages):
    ...
    def _delete_project(self, project, success_messages, error_messages):
        """Delete the project itself after all protected relations are removed"""
        try:
