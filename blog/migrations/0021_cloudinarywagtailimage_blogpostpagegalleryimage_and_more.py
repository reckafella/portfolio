# Generated by Django 5.2.4 on 2025-08-07 22:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0020_remove_viewcountattempt_view_count__article_5e338e_idx_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='blog.cloudinarywagtailimage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='CloudinaryWagtailRendition',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='blog.cloudinarywagtailimage')),
            ],
            options={
