...
import {
    sanitizeText,
    sanitizeTextDuringInput,
    sanitizeStringArrayDuringInput,
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <label className="form-label mb-0">
                            ...
                            <small className="text-muted ms-2">
                                ({entries.filter((e) => e.id).length} existing,{" "}
                                {entries.filter((e) => !e.id).length} new)
                            </small>
                        </label>
                        <button
                            type="button"
