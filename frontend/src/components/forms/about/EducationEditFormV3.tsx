 ...
 */
const EducationEditFormV3: React.FC<EducationEditFormProps> = ({ 
  ...
  const renderEntry = (
    ...
    index: number, 
    onChange: (_field: keyof EducationEntry, _value: string | boolean) => void, 
    onRemove: () => void, 
    isLoading: boolean
  ) => (
    <>
  ...
  return (
    <ArrayEditForm
      ...
      renderEntry={(
        entry,
        index,
        onChange: (_field: keyof EducationEntry, _value: string) => void,
        onRemove,
        isLoading
      ) =>
        renderEntry(
          entry,
          index,
          // Wrap onChange to accept string | boolean but only pass string
...
export default EducationEditFormV3;
