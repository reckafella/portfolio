...
export const InboxSidebar: React.FC<InboxSidebarProps> = ({
  ...
  return (
    <div className={`inbox-sidebar ${isMinimized ? 'sidebar-minimized' : ''}`}>
      <div className="card">
        <div className="card-body">
          ...
          <div className={`sidebar-content ${isMobileCollapsed ? 'd-none' : ''}`}>
                ...
                <li className="folder-item">
                  ...
                  >
                    <div className="folder-link-content">
                      ...
                      {!isMinimized && <span>All Messages</span>}
                    </div>
                    {!isMinimized && (
                      <span className="badge bg-info">{stats.total_messages}</span>
                    )}
                  </button>
                </li>
                <li className="folder-item">
                  ...
                  >
                    <div className="folder-link-content">
                      ...
                      {!isMinimized && <span>Unread</span>}
                    </div>
                    {!isMinimized && (
                      <span className="badge bg-warning">{stats.unread_count}</span>
                    )}
                  </button>
                </li>
                <li className="folder-item">
                  ...
                  >
                    ...
                    {!isMinimized && (
                      <span className="badge bg-success">{stats.read_count}</span>
                    )}
                  </button>
                </li>
              </ul>
            ...
            {!isMinimized && (
              <div className="inbox-stats mt-4">
                ...
                <div className="stat-item">
                  ...
                  <strong className="float-end">{stats.total_messages}</strong>
                </div>
                <div className="stat-item">
                  <small className="text-muted">Unread:</small>
                  <strong className="float-end text-warning">{stats.unread_count}</strong>
                </div>
                <div className="stat-item">
                  <small className="text-muted">Read:</small>
                  <strong className="float-end text-success">{stats.read_count}</strong>
                </div>
              </div>
            )}
          </div>
