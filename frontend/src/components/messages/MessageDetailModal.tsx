...
export const MessageDetailModal: React.FC<MessageDetailModalProps> = ({
  ...
  return (
    <div className="modal fade show d-block" style={{
      ...
      <div className="modal-dialog modal-xl" style={{ maxWidth: '800px', margin: '20px auto' }}>
          ...
          <div className="modal-body">
            <div className="message-detail">
              ...
              <div className="message-subject d-flex gap-1 mb-3">
                ...
                <p className="text-muted fs-5">{message.subject || '(No Subject)'}</p>
              </div>
              ...
              <div className="message-meta mb-3">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <strong>Email:</strong> 
                    <a href={`mailto:${message.email}`} className="ms-1">
                      {message.email}
                    </a>
                  </div>
                </div>
                <div className="row mt-2">
                  <div className="col-md-6">
                    <strong>Date:</strong> {format(new Date(message.created_at), 'PPP p')}
                  </div>
                  <div className="col-md-6">
                    <strong>Status:</strong> 
                    <span className={`ms-1 badge ${message.is_read ? 'bg-success' : 'bg-warning'}`}>
            ...
            <div className="d-flex justify-content-between w-100">
              ...
              <div>
                ...
                <button
                  ...
                  disabled={processing}
                >
                  <i className={`bi ${message.is_read ? 'bi-envelope' : 'bi-envelope-open'} me-2`}></i>
