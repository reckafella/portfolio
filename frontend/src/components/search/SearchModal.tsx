...
const SearchModal: React.FC<SearchModalProps> = ({ isOpen, onClose }) => {
    ...
    // Keyboard navigation is now handled inside SearchSuggestions component
    ...
    const handleInputKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        // If Enter is pressed without suggestions showing, submit the search
        if (e.key === "Enter" && !showSuggestions) {
            e.preventDefault();
            handleSearch();
        }
        // For Escape, close suggestions
                                ...
                                <div className="search-section">
                                    ...
                                    <div className="search-section-items">
                                        {recentSearches.map((search, index) => (
                                            <button
                                                key={index}
                                                className="search-section-item search-section-item-dismissible"
                                                onClick={() =>
                                            ...
                                            >
                                                ...
                                                <span>{search}</span>
                                                <button
                                                    className="search-section-item-dismiss"
                                                    onClick={(e) =>
                                        ...
                                        {popularSearches
                                            ...
                                            .map((search, index) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="search-popular-count">
                                                        ({search.count})
                                                    </span>
                                                </button>
                                            ))}
                                ...
                                popularSearches.length === 0 && (
                                    <div className="search-empty-state">
                                        ...
                                        <p className="text-muted">
                                            Search for projects, blog posts, or
