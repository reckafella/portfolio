...
export const useMetaTags = (config: MetaTagConfig): void => {
    useEffect(() => {
        ...
        const ogImageUrl =
            config.ogImage || "/static/assets/images/logo-og.png";
        ...
        updateMetaTag(
            "og:image:alt",
            config.ogTitle || config.title || "Ethan Wanyoike Portfolio",
            true,
        );
        ...
        const twitterImageUrl =
            config.twitterImage ||
            config.ogImage ||
            "/static/assets/images/logo-og.png";
        ...
        updateMetaTag(
            "twitter:image:alt",
            config.twitterTitle || config.title || "Ethan Wanyoike Portfolio",
            true,
        );
        ...
        return () => {
            ...
            updateMetaTag(
                "description",
                "Welcome to my portfolio! Explore my projects, blog, and more.",
            );
            updateMetaTag(
                "keywords",
                "portfolio, software engineer, web development, projects, blog, contact",
            );
