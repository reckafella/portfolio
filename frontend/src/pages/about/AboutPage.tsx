...
const AboutPage: React.FC = () => {
    ...
    const [sectionsBeingEditedByOthers, setSectionsBeingEditedByOthers] =
    ...
    useEffect(() => {
        const handleTabSyncMessage = (message: TabSyncMessage) => {
            if (
                message.type === "EDIT_START" &&
                message.payload.editType === "about"
            ) {
                ...
                message.payload.contentType === "about"
            ) {
                // Refresh about data when content is updated in another tab
                fetchAboutData();
                setSuccessMessage(
                    "Content updated in another tab. Page refreshed.",
                );
    ...
    const toggleGlobalEditMode = () => {
        ...
        const sections: (keyof EditState)[] = [
            "profile",
            "education",
            "experience",
            "skills",
        ...
        if (newGlobalEdit) {
            ...
            sections.forEach((section) => {
                tabSyncService.broadcastEditStart(
                    "about",
                    section,
                    user?.username,
                );
    ...
    const downloadResume = async () => {
        try {
            ...
            link.setAttribute(
                "download",
                `${data?.name?.replace(/\s+/g, "_") || "Resume"}.pdf`,
            );
            ...
            setError(
                "Failed to download resume. Please try again later." + err,
            );
            setTimeout(() => setError(null), 5000);
        }
    };
                    ...
                    <div className="mt-3">
                        ...
                        {isAuthenticated && (
                            <button
                                ...
                                title={
                                    isGlobalEditMode
                                        ? "Exit editing mode for all sections"
                ...
                {isAuthenticated && isGlobalEditMode && (
                    <div className="global-edit-mode">
                        ...
                        >
                            ...
                            <strong>Global Edit Mode Active</strong> - All
                            sections are now editable. Make your changes and
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="d-flex align-items-center mb-1">
                                <h3 className="resume-title mb-0 text-start">
                                    Summary
                                </h3>
                                {isAuthenticated && (
                                    <>
                                        ...
                                        {sectionsBeingEditedByOthers[
                                            "profile"
                                        ] && (
                                            <span
                                                className="badge bg-warning ms-2"
                                                title={`Being edited by ${sectionsBeingEditedByOthers["profile"]}`}
                                            >
                            ...
                            {editMode.profile ? (
                                <ProfileEditForm
                                    ...
                                    onUpdate={(updatedData) =>
                                        handleUpdate(
                                            "profile",
                                            updatedData as unknown as Record<
                                                string,
                                                unknown
                                            >,
                                        )
                                ...
                                {isAuthenticated && (
                                    <>
                                        ...
                                        {sectionsBeingEditedByOthers[
                                            ...
                                            <span
                                                className="badge bg-warning ms-2"
                                                title={`Being edited by ${sectionsBeingEditedByOthers["education"]}`}
                                            >
                                                <i className="bi bi-exclamation-triangle-fill me-1"></i>
                                                {
                                                    sectionsBeingEditedByOthers[
                                ...
                                {isAuthenticated && (
                                    <>
                                        ...
                                        {sectionsBeingEditedByOthers[
                                            ...
                                            <span
                                                className="badge bg-warning ms-2"
                                                title={`Being edited by ${sectionsBeingEditedByOthers["skills"]}`}
                                            >
                                                <i className="bi bi-exclamation-triangle-fill me-1"></i>
                                                {
                                                    sectionsBeingEditedByOthers[
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center mb-1">
                                <h3 className="resume-title mb-0">
                                ...
                                {isAuthenticated && (
                                    <>
                                        ...
                                        {sectionsBeingEditedByOthers[
                                            ...
                                            <span
                                                className="badge bg-warning ms-2"
                                                title={`Being edited by ${sectionsBeingEditedByOthers["experience"]}`}
                                            >
                                                <i className="bi bi-exclamation-triangle-fill me-1"></i>
                                                {
                                                    sectionsBeingEditedByOthers[
