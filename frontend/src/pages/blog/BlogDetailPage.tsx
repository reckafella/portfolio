...
import { BlogFilters, useBlogPost, useBlogStats, useDeleteBlogPost } from '@/hooks/queries/blogQueries';
...
export function BlogDetailPage() {
  ...
  const {
    ...
    useEffect(() => {
        ...
        if (urlParams.get('search')) initialFilters.tag = urlParams.get('search')!;
