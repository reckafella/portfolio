...
export function BlogEditorPage() {
    ...
    const performAutoSave = useCallback(
        async (data: BlogPostFormData) => {
            ...
            try {
                ...
                setErrors({
                    general: [`Auto-save failed. Please try again. ${error}`],
                });
            }
        },
    ...
    useEffect(() => {
        const handleTabSyncMessage = (message: TabSyncMessage) => {
            if (
                ...
                message.payload.contentType === "blog" &&
    ...
    useEffect(() => {
        ...
        if (
            formData.content &&
            formData.content !== initialContentRef.current &&
    ...
    return (
        <>
            ...
            <DevicePreviewModal
                ...
                publishedAt={
                    post?.first_published_at || new Date().toISOString()
                }
            />
        </>
    );
