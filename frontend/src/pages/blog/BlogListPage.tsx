...
export function BlogListPage() {
    ...
    useMetaTags({
        title: "Blog",
        description:
            "Explore my latest thoughts, tutorials, and insights on software development, web technologies, and more.",
        ogTitle: "Blog Articles | Ethan Wanyoike",
        ogDescription:
            "Discover articles about software development, web technologies, and programming insights.",
        ogType: "blog",
    ...
    const { data: statsData, isLoading: statsLoading } = useBlogStats();
