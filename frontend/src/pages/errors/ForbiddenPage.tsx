...
const ForbiddenPage: React.FC = () => {
    ...
    useMetaTags({
        title: "403 - Forbidden",
        description:
            "You are not authorized to access this resource. This could be because you're not logged in or don't have the required privileges.",
                        ...
                        <div className="error-content">
                            ...
                            <div className="error-message mb-4">
                                ...
                                <p className="text-muted fs-5 mb-4">
                                    ...
                                    resource. This could be because you're not
                                    logged in or don't have the required
                                    privileges.
                                </p>
                            </div>
                            {/* Security Info */}
