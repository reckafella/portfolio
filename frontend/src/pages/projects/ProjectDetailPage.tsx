...
import {
    useProjectBySlug,
    useDeleteProject,
} from "@/hooks/queries/projectQueries";
...
export const ProjectDetailPage: React.FC = () => {
    ...
    useMetaTags({
        ...
        description:
            project?.description ||
            "View this project on Ethan Wanyoike's portfolio",
        ...
        ogImage:
            project?.first_image?.optimized_image_url ||
            project?.first_image?.cloudinary_image_url,
