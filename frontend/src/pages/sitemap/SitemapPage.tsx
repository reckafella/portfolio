...
const SitemapPage: React.FC = () => {
    ...
    useMetaTags({
        title: "Sitemap",
        description:
            "Explore the sitemap of our website, including blog posts and projects. Find all pages, projects, and blog posts organized for easy navigation.",
        keywords:
            "sitemap, blog, projects, portfolio, navigation, website structure",
        ogTitle: "Sitemap - Ethan Wanyoike Portfolio",
        ogDescription:
            "Explore the sitemap of our website, including blog posts and projects.",
        ogType: "website",
    ...
    useEffect(() => {
        const fetchSitemapData = async () => {
            try {
                ...
                setError(
                    `Failed to load sitemap data: ${err instanceof Error ? err.message : "Unknown error"}`,
                );
            } finally {
                setLoading(false);
            }
                ...
                <div className="col-12">
                    <div className="text-center mb-5">
                        ...
                        <p className="lead text-muted">
                            Explore all pages, projects, and blog posts on this
                            website
                        </p>
