...
export const aboutApi = {
    ...
    education: {
        ...
        update: async (
            id: number,
            educationData: Partial<EducationEntry>,
        ): Promise<Response> => {
            return apiRequest(`/api/v1/about/education/${id}/`, {
                method: "PUT",
                body: JSON.stringify(educationData),
    ...
    experience: {
        ...
        create: async (
            experienceData: Omit<ExperienceEntry, "id">,
        ): Promise<Response> => {
            return apiRequest("/api/v1/about/experience/", {
                method: "POST",
        ...
        update: async (
            id: number,
            experienceData: Partial<ExperienceEntry>,
        ): Promise<Response> => {
            return apiRequest(`/api/v1/about/experience/${id}/`, {
                method: "PUT",
                body: JSON.stringify(experienceData),
